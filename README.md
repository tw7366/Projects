...
[CNN model tuning with EMNIST](https://github.com/tw7366/Pytorch-EMNIST-Classification) | Built an advanced CNN model to observe performance vs time consumption and perform hyperparameter tuning | [CNN](https://en.wikipedia.org/wiki/Convolutional_neural_network) | pytorch, argparse, time, collections 
